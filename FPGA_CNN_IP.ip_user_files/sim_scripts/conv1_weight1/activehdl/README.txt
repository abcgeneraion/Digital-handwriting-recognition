...
#
# Generated by export_simulation on Tue Dec 28 20:27:25 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './conv1_weight1.sh' script.

./conv1_weight1.sh -reset_run
...
./conv1_weight1.sh -noclean_files

For more information on the script, please type './conv1_weight1.sh -help'.
