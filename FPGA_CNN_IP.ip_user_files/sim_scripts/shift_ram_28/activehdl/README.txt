...
#
# Generated by export_simulation on Tue Dec 28 21:17:04 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './shift_ram_28.sh' script.

./shift_ram_28.sh -reset_run
...
./shift_ram_28.sh -noclean_files

For more information on the script, please type './shift_ram_28.sh -help'.
