...
#
# Generated by export_simulation on Tue Dec 28 21:59:01 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './image28x28.sh' script.

./image28x28.sh -reset_run
...
./image28x28.sh -noclean_files

For more information on the script, please type './image28x28.sh -help'.
