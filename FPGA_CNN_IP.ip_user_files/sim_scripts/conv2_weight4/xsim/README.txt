...
#
# Generated by export_simulation on Tue Dec 28 21:16:35 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './conv2_weight4.sh' script.

./conv2_weight4.sh -reset_run
...
./conv2_weight4.sh -noclean_files

For more information on the script, please type './conv2_weight4.sh -help'.
