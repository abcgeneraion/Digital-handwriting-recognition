...
#
# Generated by export_simulation on Tue Dec 28 21:16:07 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './conv1_bias6.sh' script.

./conv1_bias6.sh -reset_run
...
./conv1_bias6.sh -noclean_files

For more information on the script, please type './conv1_bias6.sh -help'.
