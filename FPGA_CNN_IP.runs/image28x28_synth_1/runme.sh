...
HD_PWD='C:/Users/Epoch/Desktop/FPGA_CNN_IP/FPGA_CNN_IP/FPGA_CNN_IP.runs/image28x28_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image28x28.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image28x28.tcl
