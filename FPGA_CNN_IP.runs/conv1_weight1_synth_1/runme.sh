...
HD_PWD='C:/Users/Epoch/Desktop/FPGA_CNN_IP/FPGA_CNN_IP/FPGA_CNN_IP.runs/conv1_weight1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log conv1_weight1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source conv1_weight1.tcl
